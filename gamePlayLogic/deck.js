...
//    this.name: name,
//    this.avatar: 'square img url used for background',
//    this.attack1: [attack1Name, a1damage(#1-5), a1type, 'img-src-url'], 'sound-src-url??'],
//    this.attack2: [attack2Name, a12amage(#1-5), a2type, 'img-src-url'], 'sound-src-url??'],
//    this.def: [defName, #1-5, 'img-src-url'], 'sound-src-url??'],
//    this.accuracy: #1-10,
// },
...
scorpion: {
   ...
   attack1: ['Spear', 4, 'Fighting', 'ttp://orig12.deviantart.net/75fd/f/2013/099/8/0/gif_scorpion_get_over_here_animation_mk_by_luis_mortalkombat14-d6128nw.gif'], //, 'sound-src-url??'],
